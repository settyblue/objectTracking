function [ depth ] = get_depth( tracking_position, tracking_object_position_r, tracking_object_size )
...
%   Detailed explanation goes here
    ...
    xr =  middle_column - tracking_object_position_r(1,1);
    
    simple_depth = 1.0/(xl-xr);
    depth = simple_depth;
