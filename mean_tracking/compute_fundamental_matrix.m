function [fundamental_matrix] = compute_fundamental_matrix (image1_points, image2_points)
    ...
    %size(norm_img_1_points)
    %size(norm_img_2_points)
    matrix_a = [norm_img_1_points(:, 1) .* norm_img_2_points(:, 1) norm_img_1_points(:, 2) .* norm_img_2_points(:, 1) norm_img_1_points(:, 3) .* norm_img_2_points(:, 1) norm_img_1_points(:, 1) .* norm_img_2_points(:, 2) norm_img_1_points(:, 2) .* norm_img_2_points(:, 2) norm_img_1_points(:, 3) .* norm_img_2_points(:, 2) norm_img_1_points];
