function [dest_x, dest_y, epipolar_points] = find_corresponding_point (center_x, center_y, src_img, target_img, fundamental_matrix, template_width, template_height, do_distance_correction, previous_position) 
    ...
    matching_point = template_match(target_img, template, epipolar_points, do_distance_correction, previous_position);
